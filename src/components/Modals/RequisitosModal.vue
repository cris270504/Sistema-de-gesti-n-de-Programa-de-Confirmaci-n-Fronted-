                ...
                <div class="modal-body p-0">
                    <div class="divide-y divide-gray-100">
                        <div v-for="req in docDraft.requisitos" :key="req.id" class="!p-3 flex justify-between items-center">
                            ...
                            <div v-else>
                                <span v-if="req.pivot.estado === 'entregado'" class="inline-flex items-center !gap-1 rounded-full !border border-green-200 bg-green-50 text-green-700 text-xs font-medium !px-2.5 !py-1">
                                    <CheckCircle :size="12"/> Entregado
                                </span>
                                <span v-else class="inline-flex items-center !gap-1 rounded-full !border border-amber-200 bg-amber-50 text-amber-700 text-xs font-medium !px-2.5 !py-1">
